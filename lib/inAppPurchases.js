...
export const COIN_PACKAGES = [
  { id: 'coins_100', name: '100 Coins', coins: 100, price: 0.99, popular: false },
  { id: 'coins_500', name: '500 Coins', coins: 500, price: 4.99, popular: true, bonus: 50 },
  { id: 'coins_1000', name: '1000 Coins', coins: 1000, price: 9.99, popular: false, bonus: 150 },
  { id: 'coins_2500', name: '2500 Coins', coins: 2500, price: 19.99, popular: false, bonus: 500 },
  { id: 'coins_5000', name: '5000 Coins', coins: 5000, price: 34.99, popular: false, bonus: 1500 },
];
...
export async function processPurchase(purchaseType, productId, user) {
  ...
  try {
    ...
    if (purchaseType === PURCHASE_TYPES.COINS) {
      const coinPackage = COIN_PACKAGES.find(p => p.id === productId);
      if (!coinPackage) {
